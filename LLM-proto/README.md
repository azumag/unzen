...
| WorkersCoordinatorMiniflareSmoke | `src/workers-coordinator-miniflare-smoke.ts` | Miniflare runtime の fetch / Durable Object storage / WebSocket heartbeat smoke gate |
...
focused command、report fields、次の real-runtime bottleneck は `docs/workers-coordinator-prototype.md` に置く。
...
| [docs/workers-coordinator-prototype.md](./docs/workers-coordinator-prototype.md) | Cloudflare Workers Coordinator boundary の API lifecycle / Durable Object state / WebSocket heartbeat p95 / Miniflare runtime smoke gate | **Miniflare smoke 追加済み** |
