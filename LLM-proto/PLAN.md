...
7. [Workers Coordinator Miniflare smoke](./docs/workers-coordinator-prototype.md) で、Miniflare/workerd の real Worker fetch、Durable Object storage、WebSocket upgrade、direct worker-to-worker rejection を focused smoke として検証し、次は load-shaped Wrangler preview / deployed Worker bottleneck に進む
