...
6. [`endpoint-layout-candidate-probe.md`](./endpoint-layout-candidate-probe.md) — #223 の方式決定前に4/5/8 physical payloadと8-way execution viewを比較し、CPU ORTのcomplete post-stage equivalence、4/5-way primitive、さらに4-way preferred payloadを逐次処理するcomplete final-norm + tiled-lm-headの実Chrome/Apple Metal ORT WebGPU実行まで検証するdiagnostic-only probe
