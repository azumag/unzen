...
Default construction and valid custom dependency injection retain the existing behavior. Per-run prompt and URL validation remain separate runtime boundaries.
